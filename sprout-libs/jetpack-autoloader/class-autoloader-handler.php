...
class Autoloader_Handler {
	...
	public function activate_autoloader( $plugins ) {
		...
		$this->manifest_reader->read_manifests( $plugins, 'sprout-libs/composer/jetpack_autoload_psr4.php', $jetpack_packages_psr4 );

		global $jetpack_packages_classmap;
		$jetpack_packages_classmap = array();
		$this->manifest_reader->read_manifests( $plugins, 'sprout-libs/composer/jetpack_autoload_classmap.php', $jetpack_packages_classmap );

		global $jetpack_packages_filemap;
		$jetpack_packages_filemap = array();
		$this->manifest_reader->read_manifests( $plugins, 'sprout-libs/composer/jetpack_autoload_filemap.php', $jetpack_packages_filemap );
