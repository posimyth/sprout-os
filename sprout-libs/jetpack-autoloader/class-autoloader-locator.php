...
class Autoloader_Locator {
	...
	public function get_autoloader_path( $plugin_path ) {
		return trailingslashit( $plugin_path ) . 'sprout-libs/autoload_packages.php';
	}
	...
	public function get_autoloader_version( $plugin_path ) {
		$classmap = trailingslashit( $plugin_path ) . 'sprout-libs/composer/jetpack_autoload_classmap.php';
