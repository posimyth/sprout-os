...
AUTOLOADER_COMMENT;
	...
	private static function prepareAutoloaderFile( $filename, $suffix ) {
		...
		$sourceLoader  = fopen( __DIR__ . '/' . $filename, 'r' ); // phpcs:ignore WordPress.WP.AlternativeFunctions.file_system_operations_fopen -- Third-party Composer/Jetpack library code; WP_Filesystem not applicable here.
