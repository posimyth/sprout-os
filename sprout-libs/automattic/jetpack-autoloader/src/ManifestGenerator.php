...
class ManifestGenerator {
	...
	public static function buildManifest( $autoloaderType, $fileName, $content ) {
		...
		throw new \InvalidArgumentException( 'An invalid manifest type of ' . $autoloaderType . ' was passed!' ); // phpcs:ignore WordPress.Security.EscapeOutput.ExceptionNotEscaped -- Exception message used internally, not browser output.
	}
